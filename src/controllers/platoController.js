    ...
    async listar (req, res){
        try {
            ...
            const menuCompleto = platosSql.map(p => {
                ...
                const stockInfo = stockMap[platoJson.id] || { cantidadActual: 0, esIlimitado: false };
                ...
                platoJson.stock = {
                    ...
                    estado: this._calcularEstadoStock(stockInfo.cantidadActual, stockInfo.esIlimitado)
                };
