...
const setupListeners = () => {
    ...
    pedidoEmitter.on('pedido-creado', ({ pedido }) => {
        ...
        console.log(`🧾 FACTURACIÓN: Iniciando conexión con servidor de Impuestos (AFIP)...`);
        ...
        setTimeout(() => {
            ...
            console.log(`✅ FACTURACIÓN: Factura autorizada para Cliente: ${pedido.cliente}. CAE: ${cae}`);
